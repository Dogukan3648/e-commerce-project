  ...
  return (
    <article className="flex w-87 flex-col overflow-hidden bg-white lg:w-60">
      ...
      <div className="flex flex-col items-start gap-2.5 px-6 py-6 pb-9">
        <h3 className="w-full truncate text-base font-bold leading-6 tracking-[0.1px] text-dark">
          {name}
        </h3>

        <p className="w-full truncate text-sm font-bold leading-6 tracking-[0.2px] text-muted">
          {description}
        </p>
