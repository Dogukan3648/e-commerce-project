...
const FavoritesHeaderSection = () => {
  return (
    <section className="bg-light-gray py-6">
      <div className="mx-auto flex w-full flex-col items-center gap-8 px-6 lg:max-w-263 lg:flex-row lg:justify-between lg:gap-0 lg:px-0">
        ...
        >
          ...
          <span className="text-muted lg:text-soft-gray">Favorites</span>
        </nav>
      </div>
    </section>
  );
